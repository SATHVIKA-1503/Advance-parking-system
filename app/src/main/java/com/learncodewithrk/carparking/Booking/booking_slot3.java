...
public class booking_slot3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_booking_slot3);
        ...
        Detail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent streamIntent = new Intent(booking_slot3.this, slot3_Detail_page.class);
    ...
    private void DeleteData() {
        ...
        db.collection("slot2").document("slot3")
                .delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {

                        Toast.makeText(booking_slot3.this, "Data deleted !",
    ...
    private void UpdateData() {
        ...
        DocumentReference contact = db.collection("slot2").document("slot3");
        ...
        contact.update(PHONE_KEY, "+91 9599695872")
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(booking_slot3.this, "Updated Successfully",
                                Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void ReadSingleContact() {
        ...
        DocumentReference user = db.collection("slot2").document("slot3");
    ...
    private void addNewContact(){
        ...
        db.collection("slot2").document("slot3").set(newContact)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        AlertDialog alertDialog = new AlertDialog.Builder(booking_slot3.this).create();
                ...
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(booking_slot3.this, "ERROR" +e.toString(),
                                Toast.LENGTH_SHORT).show();
