...
public class slot5_Detail_page extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_slot5_detail_page);
        ...
        qrcode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent qrAct = new Intent(slot5_Detail_page.this, QrActivity.class);
                startActivity(qrAct);
                finish();
            }
        });
        ...
        pay_now.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent pay_now = new Intent(slot5_Detail_page.this, payment_page.class);
