...
public class booking_slot1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Detail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent streamIntent = new Intent(booking_slot1.this, slot1_Detail_page.class);
    ...
    private void addRealtimeUpdate() {
        DocumentReference contactListener = db.collection("slot").document("slot1");
    ...
    private void DeleteData() {
        ...
        db.collection("slot").document("slot1")
                .delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {

                        Toast.makeText(booking_slot1.this, "Data deleted !",
    ...
    private void UpdateData() {
        ...
        DocumentReference contact = db.collection("slot").document("slot1");
        ...
        contact.update(PHONE_KEY, "+91 9599695872")
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(booking_slot1.this, "Updated Successfully",
                                Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void ReadSingleContact() {
        ...
        DocumentReference user = db.collection("slot").document("slot1");
    ...
    private void addNewslot(){
        ...
        db.collection("slot").document("slot1").set(newContact)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        AlertDialog alertDialog = new AlertDialog.Builder(booking_slot1.this).create();
                ...
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(booking_slot1.this, "ERROR" +e.toString(),
                                Toast.LENGTH_SHORT).show();
