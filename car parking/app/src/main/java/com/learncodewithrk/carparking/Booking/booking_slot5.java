...
public class booking_slot5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_booking_slot5);
        ...
        Detail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent streamIntent = new Intent(booking_slot5.this, slot5_Detail_page.class);
    ...
    private void addRealtimeUpdate() {
        DocumentReference contactListener = db.collection("slot4").document("slot5");
    ...
    private void DeleteData() {
        ...
        db.collection("slot4").document("slot5")
                .delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {

                        Toast.makeText(booking_slot5.this, "Data deleted !",
    ...
    private void UpdateData() {
        ...
        DocumentReference contact = db.collection("slot4").document("slot5");
        ...
        contact.update(PHONE_KEY, "+91 9599695872")
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(booking_slot5.this, "Updated Successfully",
                                Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void ReadSingleContact() {
        ...
        DocumentReference user = db.collection("slot4").document("slot5");
    ...
    private void addNewContact(){
        ...
        db.collection("slot4").document("slot5").set(newContact)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        AlertDialog alertDialog = new AlertDialog.Builder(booking_slot5.this).create();
                ...
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(booking_slot5.this, "ERROR" +e.toString(),
                                Toast.LENGTH_SHORT).show();
