...
public class booking_slot4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_booking_slot4);
        ...
        Detail.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent streamIntent = new Intent(booking_slot4.this, slot4_Detail_page.class);
    ...
    private void DeleteData() {
        ...
        db.collection("slot3").document("slot4")
                .delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {

                        Toast.makeText(booking_slot4.this, "Data deleted !",
    ...
    private void UpdateData() {
        ...
        DocumentReference contact = db.collection("slot3").document("slot4");
        ...
        contact.update(PHONE_KEY, "+91 9599695872")
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(booking_slot4.this, "Updated Successfully",
                                Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void ReadSingleContact() {
        ...
        DocumentReference user = db.collection("slot3").document("slot4");
    ...
    private void addNewContact(){
        ...
        db.collection("slot3").document("slot4").set(newContact)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    @Override
                    public void onSuccess(Void aVoid) {
                        AlertDialog alertDialog = new AlertDialog.Builder(booking_slot4.this).create();
                ...
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(booking_slot4.this, "ERROR" +e.toString(),
                                Toast.LENGTH_SHORT).show();
